...
$voix = [
    ...
    [
        ...
        'phrases' => [
            ["titre" => "🃏 …",
             "fr" => "*Il pose la carte du jour sur la table, sans un mot, et attend.*",
             "en" => "*He lays today's card on the table, without a word, and waits.*",
             "relance" => "*Il hausse un sourcil.* / *He raises an eyebrow.*"],
            ["titre" => "🃏 Prends ton temps",
             "fr" => "*Un hochement de tête vers l'écran. Le message est clair : à toi de jouer.*",
             "en" => "*A nod toward the screen. The message is clear: your move.*",
             "relance" => "*Il attend toujours.* / *Still waiting.*"],
            ["titre" => "🃏 Tout ou rien",
             "fr" => "*Il retourne la carte. Elle était bonne depuis le début — il le savait.*",
             "en" => "*He flips the card. It was right all along — he knew.*",
             "relance" => "*Un demi-sourire.* / *Half a smile.*"],
        ],
    ],
    [
        'nom'   => 'Ryuji Sakamoto',

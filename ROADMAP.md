...
> **1314 tests JS · 313 PHPUnit · 229 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1314 Vitest · 313 PHPUnit · 229 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

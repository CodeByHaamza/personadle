...
> **1440 tests JS · 378 PHPUnit · 253 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1440 Vitest · 378 PHPUnit · 253 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

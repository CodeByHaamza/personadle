...
> **1548 tests JS · 395 PHPUnit · 288 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                             |
| --- | --------------------------------------------- | ------------------------------------------------- |
| Q1  | Tests : 1548 Vitest · 395 PHPUnit · 288 E2E   | `npm test` · `make test-php` · `npm run test:e2e` |

...
> **1121 tests JS · 278 PHPUnit · 204 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1121 Vitest · 278 PHPUnit · 204 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

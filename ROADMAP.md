...
> **1453 tests JS · 378 PHPUnit · 258 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1453 Vitest · 378 PHPUnit · 258 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |
| Q2  | i18n EN/FR/ES/DE/IT/PT (1287 clés)             | `npm run i18n:check`                                                          |

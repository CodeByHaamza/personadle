...
> **1468 tests JS · 378 PHPUnit · 263 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1468 Vitest · 378 PHPUnit · 263 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

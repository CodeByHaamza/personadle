...
> **1031 tests JS · 270 PHPUnit · 138 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1031 Vitest · 270 PHPUnit · 138 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

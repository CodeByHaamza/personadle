...
> **1383 tests JS · 352 PHPUnit · 232 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1383 Vitest · 352 PHPUnit · 232 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

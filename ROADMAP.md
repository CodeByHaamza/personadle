...
> **1159 tests JS · 306 PHPUnit · 229 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1159 Vitest · 306 PHPUnit · 229 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

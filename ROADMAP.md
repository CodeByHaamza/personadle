...
> **1548 tests JS · 407 PHPUnit · 283 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                             |
| --- | --------------------------------------------- | ------------------------------------------------- |
| Q1  | Tests : 1548 Vitest · 407 PHPUnit · 283 E2E   | `npm test` · `make test-php` · `npm run test:e2e` |

...
> **1433 tests JS · 368 PHPUnit · 251 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1433 Vitest · 368 PHPUnit · 251 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

...
> **1029 tests JS · 270 PHPUnit · 138 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1029 Vitest · 270 PHPUnit · 138 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |
| Q2  | i18n EN/FR/ES/DE/IT/PT (1201 clés)             | `npm run i18n:check`                                                          |

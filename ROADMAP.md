...
> **1507 tests JS · 379 PHPUnit · 271 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1507 Vitest · 379 PHPUnit · 271 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

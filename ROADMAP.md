...
> **1468 tests JS · 379 PHPUnit · 261 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1468 Vitest · 379 PHPUnit · 261 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

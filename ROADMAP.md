...
> **1457 tests JS · 378 PHPUnit · 258 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1457 Vitest · 378 PHPUnit · 258 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

...
> **1383 tests JS · 345 PHPUnit · 230 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1383 Vitest · 345 PHPUnit · 230 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

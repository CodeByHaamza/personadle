...
> **1329 tests JS · 315 PHPUnit · 229 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1329 Vitest · 315 PHPUnit · 229 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

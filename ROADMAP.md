...
> **1411 tests JS · 358 PHPUnit · 243 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1411 Vitest · 358 PHPUnit · 243 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

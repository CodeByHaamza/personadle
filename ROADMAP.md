...
> **1425 tests JS · 359 PHPUnit · 247 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1425 Vitest · 359 PHPUnit · 247 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

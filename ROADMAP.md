...
> **1044 tests JS · 275 PHPUnit · 145 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 1044 Vitest · 275 PHPUnit · 145 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |

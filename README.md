...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1472%20passing-2ECC71?style=for-the-badge&logo=vitest&logoColor=white" alt="Tests">
...
| **Database** | MariaDB 10.6+ / MySQL 8.0 — 29-table relational schema, 1472+ unit tests keep the contract honest |
| **i18n** | EN · FR · ES · DE · IT · PT (1296 keys each), `en.json` is the source of truth |
...
```
Vitest + jsdom → 1472 tests unitaires (logique de jeu, backend, streak, i18n, validation données)

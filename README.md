...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-987%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 987+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1118 keys each)
...
```
Vitest + jsdom → 987 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 987 tests automatisés (Vitest + PHPUnit + Playwright).

...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1015%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 1015+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 1015 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 1015 tests automatisés (Vitest + PHPUnit + Playwright).

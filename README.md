...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1032%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 1032+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 1032 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 1032 tests automatisés (Vitest + PHPUnit + Playwright).

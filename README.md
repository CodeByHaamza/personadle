...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1152%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 28-table relational schema, 1152+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1260 keys each)
...
```
Vitest + jsdom → 1152 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 1152 tests automatisés (Vitest + PHPUnit + Playwright).

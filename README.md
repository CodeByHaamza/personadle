...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1428%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 29-table relational schema, 1428+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 1428 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
PHPUnit        → tests de logique pure + intégration DB (contrat de schéma)
Playwright     → 248 E2E sur la stack Docker complète (smoke, API, Social Link)
...
quotidiens, i18n 6 langues, panel admin, 1428 tests automatisés (Vitest + PHPUnit + Playwright).

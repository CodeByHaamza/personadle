...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1329%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 28-table relational schema, 1329+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 1329 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 1329 tests automatisés (Vitest + PHPUnit + Playwright).

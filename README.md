...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1437%20passing-2ECC71?style=for-the-badge&logo=vitest&logoColor=white" alt="Tests">
...
| **Database** | MariaDB 10.6+ / MySQL 8.0 — 29-table relational schema, 1437+ unit tests keep the contract honest |
...
```
Vitest + jsdom → 1437 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
PHPUnit        → tests de logique pure + intégration DB (contrat de schéma)
Playwright     → 253 E2E sur la stack Docker complète (smoke, API, Social Link)

...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1461%20passing-2ECC71?style=for-the-badge&logo=vitest&logoColor=white" alt="Tests">
...
| **Database** | MariaDB 10.6+ / MySQL 8.0 — 29-table relational schema, 1461+ unit tests keep the contract honest |
| **i18n** | EN · FR · ES · DE · IT · PT (1290 keys each), `en.json` is the source of truth |
...
```
Vitest + jsdom → 1461 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
PHPUnit        → tests de logique pure + intégration DB (contrat de schéma)
Playwright     → 260 E2E sur la stack Docker complète (smoke, API, Social Link)

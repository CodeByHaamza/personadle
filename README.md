...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1354%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 28-table relational schema, 1354+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 1354 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 1354 tests automatisés (Vitest + PHPUnit + Playwright).

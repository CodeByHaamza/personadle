...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1523%20passing-2ECC71?style=for-the-badge&logo=vitest&logoColor=white" alt="Tests">
...
| **Database** | MariaDB 10.6+ / MySQL 8.0 — 30-table relational schema, 1523+ unit tests keep the contract honest |
...
```
Vitest + jsdom → 1523 tests unitaires (logique de jeu, backend, streak, i18n, validation données)

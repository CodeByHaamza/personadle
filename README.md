...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1440%20passing-2ECC71?style=for-the-badge&logo=vitest&logoColor=white" alt="Tests">
...
| **Database** | MariaDB 10.6+ / MySQL 8.0 — 29-table relational schema, 1440+ unit tests keep the contract honest |
...
```
Vitest + jsdom → 1440 tests unitaires (logique de jeu, backend, streak, i18n, validation données)

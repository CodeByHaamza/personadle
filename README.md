...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1484%20passing-2ECC71?style=for-the-badge&logo=vitest&logoColor=white" alt="Tests">
...
| **Database** | MariaDB 10.6+ / MySQL 8.0 — 30-table relational schema, 1484+ unit tests keep the contract honest |
| **i18n** | EN · FR · ES · DE · IT · PT (1308 keys each), `en.json` is the source of truth |
...
```
Vitest + jsdom → 1484 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
PHPUnit        → tests de logique pure + intégration DB (contrat de schéma)
Playwright     → 265 E2E sur la stack Docker complète (smoke, API, Social Link)

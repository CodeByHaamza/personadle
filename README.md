...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1029%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 1029+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1201 keys each)
...
```
Vitest + jsdom → 1029 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 1029 tests automatisés (Vitest + PHPUnit + Playwright).

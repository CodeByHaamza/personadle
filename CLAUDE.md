...
├── lang/                ← en.json (source de vérité, 1205 clés), fr/es/de/it/pt.json
...
├── tests/               ← 59 suites Vitest (1031 tests) + tests/php/ (PHPUnit)
...
- **1031 tests** (Vitest + jsdom), 59 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

...
├── lang/                ← en.json (source de vérité, 1240 clés), fr/es/de/it/pt.json
...
├── tests/               ← 65 suites Vitest (1144 tests) + tests/php/ (PHPUnit)
...
- **1144 tests** (Vitest + jsdom), 65 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

...
├── lang/                ← en.json (source de vérité, 1286 clés), fr/es/de/it/pt.json
...
├── tests/               ← 77 suites Vitest (1431 tests) + tests/php/ (PHPUnit)
...
- **1431 tests** (Vitest + jsdom), 77 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

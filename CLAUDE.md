...
├── lang/                ← en.json (source de vérité, 1293 clés), fr/es/de/it/pt.json
...
├── tests/               ← 81 suites Vitest (1477 tests) + tests/php/ (PHPUnit)
...
- **1477 tests** (Vitest + jsdom), 81 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

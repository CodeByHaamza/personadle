...
├── lang/                ← en.json (source de vérité, 1296 clés), fr/es/de/it/pt.json
...
├── tests/               ← 82 suites Vitest (1493 tests) + tests/php/ (PHPUnit)
...
- **1493 tests** (Vitest + jsdom), 82 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

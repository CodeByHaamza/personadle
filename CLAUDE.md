...
├── lang/                ← en.json (source de vérité, 1266 clés), fr/es/de/it/pt.json
...
├── tests/               ← 76 suites Vitest (1383 tests) + tests/php/ (PHPUnit)
...
- **1383 tests** (Vitest + jsdom), 76 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

...
├── lang/                ← en.json (source de vérité, 1190 clés), fr/es/de/it/pt.json
...
├── tests/               ← 57 suites Vitest (1014 tests) + tests/php/ (PHPUnit)
...
- **1014 tests** (Vitest + jsdom), 57 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

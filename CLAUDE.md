...
├── lang/                ← en.json (source de vérité, 1192 clés), fr/es/de/it/pt.json
...
├── tests/               ← 57 suites Vitest (1016 tests) + tests/php/ (PHPUnit)
...
- **1016 tests** (Vitest + jsdom), 57 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

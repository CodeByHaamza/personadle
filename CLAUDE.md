...
├── lang/                ← en.json (source de vérité, 1290 clés), fr/es/de/it/pt.json
...
<<<<<<< HEAD
├── tests/               ← 79 suites Vitest (1461 tests) + tests/php/ (PHPUnit)
=======
<<<<<<< HEAD
...
<<<<<<< HEAD
- **1461 tests** (Vitest + jsdom), 79 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
=======
<<<<<<< HEAD

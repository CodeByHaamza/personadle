...
├── lang/                ← en.json (source de vérité, 1253 clés), fr/es/de/it/pt.json
...
├── tests/               ← 65 suites Vitest (1156 tests) + tests/php/ (PHPUnit)
...
- **1156 tests** (Vitest + jsdom), 65 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

...
├── lang/                ← en.json (source de vérité, 1311 clés), fr/es/de/it/pt.json
...
├── tests/               ← 82 suites Vitest (1497 tests) + tests/php/ (PHPUnit)
...
- **1497 tests** (Vitest + jsdom), 82 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

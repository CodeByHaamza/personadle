...
├── lang/                ← en.json (source de vérité, 1217 clés), fr/es/de/it/pt.json
...
├── tests/               ← 60 suites Vitest (1043 tests) + tests/php/ (PHPUnit)
...
- **1043 tests** (Vitest + jsdom), 60 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

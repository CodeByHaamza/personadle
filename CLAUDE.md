...
├── lang/                ← en.json (source de vérité, 1260 clés), fr/es/de/it/pt.json
...
├── tests/               ← 65 suites Vitest (1152 tests) + tests/php/ (PHPUnit)
...
- **1152 tests** (Vitest + jsdom), 65 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

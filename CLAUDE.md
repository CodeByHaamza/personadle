...
├── lang/                ← en.json (source de vérité, 1201 clés), fr/es/de/it/pt.json
...
├── tests/               ← 59 suites Vitest (1029 tests) + tests/php/ (PHPUnit)
...
- **1029 tests** (Vitest + jsdom), 59 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

...
├── lang/                ← en.json (source de vérité, 1118 clés), fr/es/de/it/pt.json
...
├── tests/               ← 55 suites Vitest (987 tests) + tests/php/ (PHPUnit)
...
- **987 tests** (Vitest + jsdom), 55 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,

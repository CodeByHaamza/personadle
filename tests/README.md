...
<img src="https://img.shields.io/badge/Vitest-1498%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 271 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1498 tests unitaires (jsdom, 82 fichiers)
...
| **Total**                        |**1498**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

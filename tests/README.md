...
<img src="https://img.shields.io/badge/Vitest-1016%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 138 tests (stack Docker réelle)
               ╱────╲     smoke (5) + API badges/streak (2) + Social Link ami→XP→rang (6)
              ╱      ╲
             ╱────────╲   PHPUnit — 269 méthodes (15 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 1016 tests unitaires (jsdom, 57 fichiers)
...
| **Total**                        |**1016**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
...
> **269 méthodes de test** au total sur ces 15 fichiers. Les tests d'intégration tournent dans

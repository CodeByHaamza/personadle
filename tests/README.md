...
<img src="https://img.shields.io/badge/Vitest-1448%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 397 méthodes (23 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 1448 tests unitaires (jsdom, 77 fichiers)
...
| **Total**                        |**1448**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
...
> **397 méthodes de test** au total sur ces 23 fichiers. Les tests d'intégration tournent dans

...
<img src="https://img.shields.io/badge/Vitest-1409%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 239 tests (stack Docker réelle)
               ╱────╲     smoke (5) + API badges/streak (2) + Social Link ami→XP→rang (6)
              ╱      ╲
             ╱────────╲   PHPUnit — 358 méthodes (21 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 1409 tests unitaires (jsdom, 77 fichiers)
...
| **Total**                        |**1409**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
...
> **358 méthodes de test** au total sur ces 21 fichiers. Les tests d'intégration tournent dans

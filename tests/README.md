...
<img src="https://img.shields.io/badge/Vitest-1499%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 267 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1499 tests unitaires (jsdom, 82 fichiers)
...
| **Total**                        |**1499**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

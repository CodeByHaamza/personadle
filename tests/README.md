...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 377 méthodes (22 fichiers, dont intégration vraie MariaDB)
...
> **377 méthodes de test** au total sur ces 22 fichiers. Les tests d'intégration tournent dans

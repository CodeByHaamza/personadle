...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 245 tests (stack Docker réelle)
               ╱────╲     smoke (5) + API badges/streak (2) + Social Link ami→XP→rang (6)
              ╱      ╲
             ╱────────╲   PHPUnit — 363 méthodes (22 fichiers, dont intégration vraie MariaDB)
...
> **363 méthodes de test** au total sur ces 22 fichiers. Les tests d'intégration tournent dans

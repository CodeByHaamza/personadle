...
<img src="https://img.shields.io/badge/Vitest-1433%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 251 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1433 tests unitaires (jsdom, 77 fichiers)
...
| **Total**                        |**1433**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

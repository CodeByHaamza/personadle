...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 246 tests (stack Docker réelle)
               ╱────╲     smoke (5) + API badges/streak (2) + Social Link ami→XP→rang (6)
              ╱      ╲
             ╱────────╲   PHPUnit — 362 méthodes (21 fichiers, dont intégration vraie MariaDB)
...
> **362 méthodes de test** au total sur ces 21 fichiers. Les tests d'intégration tournent dans

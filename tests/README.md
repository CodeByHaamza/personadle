...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 363 méthodes (21 fichiers, dont intégration vraie MariaDB)
...
> **363 méthodes de test** au total sur ces 21 fichiers. Les tests d'intégration tournent dans

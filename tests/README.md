...
<img src="https://img.shields.io/badge/Vitest-987%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 987 tests unitaires (jsdom, 55 fichiers)
...
| **Total**                        |**987**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

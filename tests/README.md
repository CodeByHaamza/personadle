...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 351 méthodes (21 fichiers, dont intégration vraie MariaDB)
...
> **351 méthodes de test** au total sur ces 21 fichiers. Les tests d'intégration tournent dans

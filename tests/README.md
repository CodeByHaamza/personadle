...
<img src="https://img.shields.io/badge/Vitest-1548%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 288 tests (stack Docker réelle)
               ╱────╲     smoke (5) + API badges/streak (2) + Social Link ami→XP→rang (6)
              ╱      ╲
             ╱────────╲   PHPUnit — 395 méthodes (23 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 1548 tests unitaires (jsdom, 86 fichiers)
...
| **Total**                        |**1548**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
...
> **395 méthodes de test** au total sur ces 23 fichiers. Les tests d'intégration tournent dans

...
<img src="https://img.shields.io/badge/Vitest-1117%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 174 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1117 tests unitaires (jsdom, 64 fichiers)
...
| **Total**                        |**1117**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

...
<img src="https://img.shields.io/badge/Vitest-1461%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1461 tests unitaires (jsdom, 79 fichiers)
...
| **Total**                        |**1461**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

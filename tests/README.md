...
<img src="https://img.shields.io/badge/Vitest-986%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 134 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 986 tests unitaires (jsdom, 55 fichiers)
...
| **Total**                        |**986**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

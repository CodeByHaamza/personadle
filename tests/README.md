...
<img src="https://img.shields.io/badge/Vitest-1468%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1468 tests unitaires (jsdom, 80 fichiers)
...
| **Total**                        |**1468**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

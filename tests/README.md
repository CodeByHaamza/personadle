...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 372 méthodes (22 fichiers, dont intégration vraie MariaDB)
...
> **372 méthodes de test** au total sur ces 22 fichiers. Les tests d'intégration tournent dans

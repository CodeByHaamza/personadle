...
<img src="https://img.shields.io/badge/Vitest-1152%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1152 tests unitaires (jsdom, 65 fichiers)
...
| **Total**                        |**1152**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

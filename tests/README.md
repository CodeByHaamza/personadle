...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 370 méthodes (22 fichiers, dont intégration vraie MariaDB)
...
> **370 méthodes de test** au total sur ces 22 fichiers. Les tests d'intégration tournent dans

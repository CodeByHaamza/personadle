...
<img src="https://img.shields.io/badge/Vitest-1383%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 338 méthodes (20 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 1383 tests unitaires (jsdom, 76 fichiers)
...
| **Total**                        |**1383**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
...
> **338 méthodes de test** au total sur ces 20 fichiers. Les tests d'intégration tournent dans

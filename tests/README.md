...
<img src="https://img.shields.io/badge/Vitest-1169%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1169 tests unitaires (jsdom, 66 fichiers)
...
| **Total**                        |**1169**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

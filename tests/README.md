...
<img src="https://img.shields.io/badge/Vitest-1431%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 249 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1431 tests unitaires (jsdom, 77 fichiers)
...
| **Total**                        |**1431**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

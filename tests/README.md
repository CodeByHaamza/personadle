...
<img src="https://img.shields.io/badge/Vitest-1159%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 306 méthodes (18 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 1159 tests unitaires (jsdom, 66 fichiers)
...
| **Total**                        |**1159**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
...
> **306 méthodes de test** au total sur ces 18 fichiers. Les tests d'intégration tournent dans

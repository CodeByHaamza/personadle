...
<img src="https://img.shields.io/badge/Vitest-1523%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1523 tests unitaires (jsdom, 84 fichiers)
...
| **Total**                        |**1523**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

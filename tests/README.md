...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 345 méthodes (20 fichiers, dont intégration vraie MariaDB)
...
> **345 méthodes de test** au total sur ces 20 fichiers. Les tests d'intégration tournent dans

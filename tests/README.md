...
<img src="https://img.shields.io/badge/Vitest-1472%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 260 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1472 tests unitaires (jsdom, 80 fichiers)
...
| **Total**                        |**1472**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

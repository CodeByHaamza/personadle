...
<img src="https://img.shields.io/badge/Vitest-1478%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 264 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 1478 tests unitaires (jsdom, 81 fichiers)
...
| **Total**                        |**1478**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |

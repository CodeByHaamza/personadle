...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 280 méthodes (18 fichiers, dont intégration vraie MariaDB)
...
> **280 méthodes de test** au total sur ces 18 fichiers. Les tests d'intégration tournent dans

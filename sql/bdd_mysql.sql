...
INSERT INTO titles (slug, image_path, name_en, name_fr, name_es, name_de, name_it, name_pt, description_en, description_fr, description_es, description_de, description_it, description_pt, condition_type, condition_mode, condition_value, rarity) VALUES
('velvet_room_thou_art_i',
 'profile/titles/velvet_room_thou_art_i.webp',
 'Thou Art I',
 'Thou Art I',
 'Thou Art I',
 'Thou Art I',
 'Thou Art I',
 'Thou Art I',
 'Unlock 20 badges. The door of the Velvet Room opens to those who have gathered enough of themselves.',
 'Débloque 20 badges. La porte de la Velvet Room s''ouvre à qui a rassemblé assez de soi-même.',
 'Desbloquea 20 insignias. La puerta de la Velvet Room se abre a quien ha reunido suficiente de sí mismo.',
 'Schalte 20 Abzeichen frei. Die Tür des Velvet Room öffnet sich dem, der genug von sich selbst gesammelt hat.',
 'Sblocca 20 badge. La porta della Velvet Room si apre a chi ha raccolto abbastanza di sé.',
 'Desbloqueie 20 emblemas. A porta da Velvet Room se abre para quem reuniu o suficiente de si mesmo.',
 'badges_count',
 NULL,
 20,
 'legendary'),
('joker_looking_cool',
 'profile/titles/joker_looking_cool.webp',
 'Looking Cool',
 'Looking Cool',
 'Looking Cool',
 'Looking Cool',
 'Looking Cool',
 'Looking Cool',
 'Equip the All-Out Attack theme with a Persona 5 signature track. Style is a choice, and you made it.',
 'Équipe le thème All-Out Attack avec une musique emblématique de Persona 5. Le style est un choix, et tu l''as fait.',
 'Equipa el tema All-Out Attack con una canción emblemática de Persona 5. El estilo es una elección, y tú la hiciste.',
 'Rüste das All-Out-Attack-Design mit einem Persona-5-Titelsong aus. Stil ist eine Entscheidung, und du hast sie getroffen.',
 'Equipaggia il tema All-Out Attack con un brano simbolo di Persona 5. Lo stile è una scelta, e tu l''hai fatta.',
 'Equipe o tema All-Out Attack com uma música marcante de Persona 5. Estilo é uma escolha, e você a fez.',
 'joker_profile',
 NULL,
 0,
 'legendary'),
('makoto_yuki_memento_mori',
 'profile/titles/makoto_yuki_memento_mori.webp',
 'Memento Mori',
 'Memento Mori',
 'Memento Mori',
 'Memento Mori',
 'Memento Mori',
 'Memento Mori',
 'Play on 100 different days. Every day counts, because none of them comes back.',
 'Joue 100 jours différents. Chaque jour compte, parce qu''aucun ne revient.',
 'Juega 100 días distintos. Cada día cuenta, porque ninguno vuelve.',
 'Spiel an 100 verschiedenen Tagen. Jeder Tag zählt, denn keiner kommt zurück.',
 'Gioca in 100 giorni diversi. Ogni giorno conta, perché nessuno torna.',
 'Jogue em 100 dias diferentes. Cada dia conta, porque nenhum deles volta.',
 'unique_days',
 NULL,
 100,
 'epic'),
('aigis_i_am_not_afraid',
 'profile/titles/aigis_i_am_not_afraid.webp',
 'I Am Not Afraid',
 'Je N''''Ai Pas Peur',
 'No Tengo Miedo',
 ...
 'Non Ho Paura',
 'Não Tenho Medo',
 'Win 50 Classic games. Fear was a setting, and you turned it off.',
 'Gagne 50 parties en Classique. La peur était un réglage, et tu l''as coupé.',
 'Gana 50 partidas en Clásico. El miedo era un ajuste, y lo apagaste.',
 'Gewinne 50 Klassik-Runden. Angst war eine Einstellung, und du hast sie abgeschaltet.',
 'Vinci 50 partite in Classico. La paura era un''impostazione, e l''hai disattivata.',
 'Vença 50 partidas no Clássico. O medo era uma configuração, e você a desligou.',
 'mode_wins',
 'classic',
 50,
 'rare'),
('akechi_pancakes',
 'profile/titles/akechi_pancakes.webp',
 'Pancakes?',
 'Pancakes ?',
 '¿Panqueques?',
 'Pfannkuchen?',
 'Pancakes?',
 'Panquecas?',
 'Play 3 different modes within 7 days. One slip is all it takes to give yourself away.',
 'Joue 3 modes différents en 7 jours. Un seul mot de trop suffit à se trahir.',
 'Juega 3 modos distintos en 7 días. Basta un desliz para delatarse.',
 'Spiel 3 verschiedene Modi innerhalb von 7 Tagen. Ein Versprecher genügt, um sich zu verraten.',
 'Gioca 3 modalità diverse in 7 giorni. Basta una parola di troppo per tradirsi.',
 'Jogue 3 modos diferentes em 7 dias. Um deslize basta para se entregar.',
 'weekly_clean_modes',
 NULL,
 3,
 'epic'),
('yosuke_ride_the_wind',
 'profile/titles/yosuke_ride_the_wind.webp',
 'Ride the Wind',
 'Chevauche le Vent',
 'Cabalga el Viento',
 'Reite den Wind',
 'Cavalca il Vento',
 'Cavalgue o Vento',
 'Have 5 friends. Nobody rides the wind alone.',
 'Aie 5 amis. Personne ne chevauche le vent seul.',
 'Ten 5 amigos. Nadie cabalga el viento solo.',
 'Hab 5 Freunde. Niemand reitet den Wind allein.',
 'Avere 5 amici. Nessuno cavalca il vento da solo.',
 'Tenha 5 amigos. Ninguém cavalga o vento sozinho.',
 'friends_count',
 NULL,
 5,
 'rare'),
('adachi_boring_isnt_it',
 'profile/titles/adachi_boring_isnt_it.webp',
 'Boring, Isn''''t It?',
 ...
 'Noioso, Vero?',
 'Chato, Não É?',
 'Give up 50 times. Some people just stop caring — and say so.',
 'Abandonne 50 fois. Certains cessent simplement de s''en soucier — et le disent.',
 'Ríndete 50 veces. Algunos simplemente dejan de importarles, y lo dicen.',
 'Gib 50 Mal auf. Manche hören einfach auf, sich zu kümmern — und sagen es.',
 'Arrenditi 50 volte. Alcuni smettono semplicemente di curarsene, e lo dicono.',
 'Desista 50 vezes. Algumas pessoas simplesmente param de se importar, e dizem isso.',
 'giveups_total',
 NULL,
 50,
 'common'),
('marie_i_remembered',
 'profile/titles/marie_i_remembered.webp',
 'I Remembered',
 'Je Me Suis Souvenu',
 'Lo Recordé',
 'Ich Erinnerte Mich',
 'Mi Sono Ricordato',
 'Eu Me Lembrei',
 'Unlock 15 badges. Piece by piece, the memories come back.',
 'Débloque 15 badges. Morceau par morceau, les souvenirs reviennent.',
 'Desbloquea 15 insignias. Pieza a pieza, los recuerdos vuelven.',
 'Schalte 15 Abzeichen frei. Stück für Stück kehren die Erinnerungen zurück.',
 'Sblocca 15 badge. Pezzo dopo pezzo, i ricordi tornano.',
 'Desbloqueie 15 emblemas. Peça por peça, as memórias voltam.',
 'badges_count',
 NULL,
 15,
 'rare'),
('yu_reach_out_to_the_truth',
 'profile/titles/yu_reach_out_to_the_truth.webp',
 ...
 'Raggiungi la Verita',
 'Alcance a Verdade',
 'Win at least once in all six modes. The truth hides in the fog until you look everywhere.',
 'Gagne au moins une fois dans les six modes. La vérité se cache dans le brouillard tant qu''on n''a pas cherché partout.',
 'Gana al menos una vez en los seis modos. La verdad se esconde en la niebla hasta que miras en todas partes.',
 'Gewinne mindestens einmal in allen sechs Modi. Die Wahrheit versteckt sich im Nebel, bis du überall gesucht hast.',
 'Vinci almeno una volta in tutte le sei modalità. La verità si nasconde nella nebbia finché non guardi ovunque.',
 'Vença pelo menos uma vez em todos os seis modos. A verdade se esconde na névoa até que você procure em todo lugar.',
 'all_modes_won',
 NULL,
 1,
 'epic'),
('investigation_team',
 'profile/titles/investigation_team.webp',
 'Investigation Team',
 'Investigation Team',
 'Investigation Team',
 'Investigation Team',
 'Investigation Team',
 'Investigation Team',
 'Win 8 Personae games. Eight members, eight cases closed.',
 'Gagne 8 parties en Personae. Huit membres, huit affaires résolues.',
 'Gana 8 partidas en Personae. Ocho miembros, ocho casos cerrados.',
 'Gewinne 8 Personae-Runden. Acht Mitglieder, acht gelöste Fälle.',
 'Vinci 8 partite in Personae. Otto membri, otto casi chiusi.',
 'Vença 8 partidas no Personae. Oito membros, oito casos encerrados.',
 'mode_wins',
 'personae',
 8,
 'epic'),
('junes',
 'profile/titles/junes.webp',
 'Junes',
 'Junes',
 'Junes',
 'Junes',
 'Junes',
 'Junes',
 'Win 15 Music games. Every day''s great at your Junes.',
 'Gagne 15 parties en Musique. Every day''s great at your Junes.',
 'Gana 15 partidas en Música. Every day''s great at your Junes.',
 'Gewinne 15 Musik-Runden. Every day''s great at your Junes.',
 'Vinci 15 partite in Musica. Every day''s great at your Junes.',
 'Vença 15 partidas no Música. Every day''s great at your Junes.',
 'mode_wins',
 'music',
 15,
 'rare'),
('naoya_first_awakening',
 'profile/titles/naoya_first_awakening.webp',
 'The First Awakening',
 'Le Premier Éveil',
 'El Primer Despertar',
 'Das Erste Erwachen',
 ...
 'Win 15 Classic games with the Persona 1 filter. It all began in 1996, at St. Hermelin.',
 'Gagne 15 parties en Classique avec le filtre Persona 1. Tout a commencé en 1996, à St. Hermelin.',
 'Gana 15 partidas en Clásico con el filtro Persona 1. Todo empezó en 1996, en St. Hermelin.',
 'Gewinne 15 Klassik-Runden mit dem Persona-1-Filter. Alles begann 1996, an der St. Hermelin.',
 'Vinci 15 partite in Classico con il filtro Persona 1. Tutto è iniziato nel 1996, alla St. Hermelin.',
 'Vença 15 partidas no Clássico com o filtro Persona 1. Tudo começou em 1996, na St. Hermelin.',
 'classic_p1_wins',
 NULL,
 15,
 'rare'),
('maya_always_be_positive',
 'profile/titles/maya_always_be_positive.webp',
 'Always Be Positive',
 'Toujours Positif',
 'Siempre Positivo',
 'Immer Positiv',
 'Sempre Positivo',
 'Sempre Positiva',
 'Win 10 Emoji games with the Persona 2 filter. Let''s positive thinking!',
 'Gagne 10 parties en Emoji avec le filtre Persona 2. Let''s positive thinking !',
 'Gana 10 partidas en Emoji con el filtro Persona 2. Let''s positive thinking!',
 'Gewinne 10 Emoji-Runden mit dem Persona-2-Filter. Let''s positive thinking!',
 'Vinci 10 partite in Emoji con il filtro Persona 2. Let''s positive thinking!',
 'Vença 10 partidas no Emoji com o filtro Persona 2. Let''s positive thinking!',
 'emoji_p2_wins',
 NULL,
 10,
 'common'),
('shadows_converge',
 'profile/titles/shadows_converge.webp',
 'Shadows Converge',
 'Shadows Converge',
 'Shadows Converge',
 'Shadows Converge',
 'Shadows Converge',
 'Shadows Converge',
 'Win 50 games in Expert Mode, across all modes. Where the shadows gather, only the best remain.',
 'Gagne 50 parties en Mode Expert, tous modes confondus. Là où les ombres convergent, seuls les meilleurs restent.',
 'Gana 50 partidas en Modo Experto, sumando todos los modos. Donde convergen las sombras, solo quedan los mejores.',
 'Gewinne 50 Runden im Expertenmodus, über alle Modi hinweg. Wo die Schatten sich sammeln, bleiben nur die Besten.',
 'Vinci 50 partite in Modalità Esperto, in tutte le modalità. Dove le ombre convergono, restano solo i migliori.',
 'Vença 50 partidas no Modo Expert, somando todos os modos. Onde as sombras convergem, só os melhores permanecem.',
 'expert_wins_total',
 NULL,
 50,
 'legendary'),
('sees',
 ...
 'Um esquadrão não é uma pessoa só. Reúna oito títulos e a braçadeira é sua.',
 'titles_count',
 NULL,
 8,
 'epic'),
('aigis_metis_same_soul',
 ...
 'Leve um vínculo até o rank 10. Duas máquinas aprenderam o quanto isso custa.',
 'social_link_min_rank',
 NULL,
 10,
 'epic'),
('kotone_not_a_princess',
 ...
 'Vença 25 partidas sem um único erro. Ninguém vem te salvar: quem salva é você.',
 'perfect_wins',
 NULL,
 25,
 'rare'),
('naoto_case_never_closed',
 ...
 'L''''affaire n''''est jamais close',
 'El caso nunca se cierra',
 'Der Fall ist nie abgeschlossen',
 'Il caso non è mai chiuso',
 'O Caso Nunca Se Encerra',
 ...
 'Identifique 25 silhuetas. Um detetive não para na primeira confissão.',
 'mode_wins',
 'silhouette',
 25,
 'rare'),
('shinjiro_no_pity',
 ...
 'Consiga 25 vitórias rápidas no Clássico. Sem dicas, sem ajuda, sem pena.',
...
('take_your_heart',
 ...
 'Vença 40 partidas de All-Out Attack. O cartão de visita é só o começo.',
 'mode_wins',
 'alloutattack',
 40,
 'legendary'),
('tatsuya_dont_burn_out',
 ...
 'Some Things Don''''t Burn Out',
 'Certaines choses ne s''''éteignent pas',
 'Algunas cosas no se apagan',
 'Manches erlischt nie',
 'Certe cose non si spengono',
 'Algumas Coisas Não Se Apagam',
 ...
 'Jogue em um 24 de junho, de qualquer ano: o dia em que Innocent Sin foi lançado. Uma chama acesa desde 1999.',
 'played_on_date',
 '06-24',
 NULL,
 'legendary'),
('wonder_go_beyond',
 ...
 'Tudo de Wonder: seus cinco All-Out Attack, ele mesmo no Clássico e no Emoji, Jánošík no Personae (normal e Expert), e todas as músicas de P5X no Música (normal e Expert). Não sobra nada para encontrar.',
 'targets_found',
 'wonder_go_beyond',
 NULL,
 'legendary');
